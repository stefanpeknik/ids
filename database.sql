...
CREATE TABLE PERSON (
    ...
    PERSON_PERSONAL_ID NUMBER(10) NOT NULL CHECK(PERSON_PERSONAL_ID >= 100000000 AND PERSON_PERSONAL_ID <= 9999999999), -- does not contain / or - in the middle, accepts 9 to 10 digits beacuse of people born before 1985
